\begin{tad}
  ...
  \tadDependances{Booleen, Eléments Comparables}
  \begin{tadOperations}{FileDePriorité}
    ...
    \tadOperationAvecPreconditions{obtenirElement}{\tadUnParam{FileDePriorité}}{\tadUnParam{Elément}}
    \tadOperation{insérer}{\tadDeuxParams{FileDePriorité}{Elément}}{\tadUnParam{fileDePriorité}}
  \end{tadOperations}
  \begin{tadAxiomes}
  ...
  \begin{tadPreconditions}{FileDePriorité}
    ...
    \tadPrecondition{Elément possède comparerElements}
