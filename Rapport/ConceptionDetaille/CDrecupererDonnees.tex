...
\begin{algorithme}
  \procedure{recupererLongueur}{
    \paramEntreeSortie{fichierSource : FB\_FichierBinaire, *longueur : int}
    }
    {
    }
    {
...
\begin{algorithme}
  \procedure{recupererDonnees}{
    \paramEntreeSortie{fichierSource : FB\_FichierBinaire, *stat : STAT\_Statistiques, *longueur : int}
    }
    {
